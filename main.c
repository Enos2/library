...
#define FILE_NAME  "Enosomondibooks.bin"
...
void welcomeMessage()
{
    headMessage("www.enosomondibooks.com");
    printf("\n\n\n\n\n");
    printf("\n\t\t\t  **-**-**-**-**-**-**-**-**-**-**-**-**-**-**-**-**-**-**\n");
    printf("\n\t\t\t        =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=");
    printf("\n\t\t\t        =                 WELCOME                   =");
...
void init()
{
    FILE *fp = NULL;
    int status = 0;
    const char defaultUsername[] ="enosbooks\n";
    const char defaultPassword[] ="enosbooks\n";
    sFileHeader fileHeaderInfo = {0};
